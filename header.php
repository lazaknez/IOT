...
<nav class="navbar fixed-top navbar-expand-lg navbar-light fixed-top" style="background-color:#cca01d ;">
  <div class="container">
    <a class="navbar-brand" href="index.php"><strong><i>BeoStan Agencija</i></strong></a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item <?php if($page == 'stanovi') echo 'active' ?>">
          <a class="nav-link" href="stanovi.php">Ponuda stanova</a>
        </li>
